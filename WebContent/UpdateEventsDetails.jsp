				 ...
				 <jsp:include page="scroll.html"/> 
                    ...
                    <table width="200" border="0" align="center">
                      ...
                      <tr align="center" height="25px">
                        <td bgcolor="#FFD7AE" style="font-size: 18px; font-weight: bold;"><a href="vieweventdetails.jsp?eventid=<%=eventid%>" class="style12"><%=eventdto.getEventname() %></a></td>
                        <td bgcolor="#FFD7AE" style="font-size: 18px; font-weight: bold;"><span class="style12"><%=DateWrapper.parseDate(eventdto.getEventdate1())%></span></td>
                         <td bgcolor="#FFD7AE" style="font-size: 18px; font-weight: bold;"><span class="style12"><%=eventdto.getEventtime()%></span></td>
                        <td bgcolor="#FFD7AE" style="font-size: 18px; font-weight: bold;"><span class="style12"><%=eventdto.getVenue()%></span></td>
                        <td bgcolor="#FFD7AE" style="font-size: 18px; font-weight: bold;"><span class="style12"><%=eventdto.getStatus()%></span></td>
                      </tr>
                      <%} %>
                    </table>
