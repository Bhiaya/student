...
<script type="text/javascript" src="scripts/ts_picker.js"></script>
 ...
 <jsp:include page="generaloptions.html"></jsp:include>
<br/>         
                ...
                <tr>
				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                                <td width="412" valign="top"> <form action="AcadamicdetailsAction.jsp" method="post" name="acadamicupdate">
                            ...
                            <tr>
                              ...
                              <td><table width="480" border="0" align="center" cellspacing="15">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="rollno" style="height:25px; font-size:12pt" style="height:25px; font-size:12pt">
                                   </td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><div align="center"><br/>
                                      <input type="submit" name="Submit" value="Sign In" style="height:30px; width: 100px; font-size:18px;">
