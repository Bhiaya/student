 ...
 <TABLE cellSpacing=0 cellPadding=0 width=900 align=center bgColor="#F5FFFA" 
      ...
      document.write(TODAY);	</script></FONT></span><BR>
              ...
              <TR>
                ...
                <jsp:include page="generaloptions.html"/> </div></TD><td width="63">&nbsp;</td>
                </TR>
              <TR>
              ...
              <TR>
                ...
                <tr>
                  ...
                  <td width="412"> <form action="RecoverPasswordAction.jsp" method="post" name="register">
                    <table width="200" border="0" align="center">
                      ...
                      <tr>
                        <td><table width="314" height="206" border="0" align="center" bordercolor="#CD817E" bgcolor="#FAF9DE">
                          <tr>
                            <td width="1" height="57" valign="top"></td>
                            <td width="280"><div align="center" class="style24">F o r g o t  P a s s w o r d</div></td>
                            <td width="29"></td>
                          </tr>
                          <tr>
                            <td height="120" align="right"></td>
                            <td><table width="388" border="0" align="center">
                              <tr>
                    ...
                    <p align="center"><a href="RegisterForm.jsp"><img src="images/reg.gif" width="121" height="37" border="0"></a>&nbsp;<a href="search.jsp"><img src="images/search.gif" width="149" height="40" border="0"></a></p>
                  </form>			</td>
                </tr>
                  </table>			      </TD>
