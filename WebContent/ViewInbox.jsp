				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="412" border="0" align="center">
					  ...
					  {%>
					  <span class="style3" style="font-size: 28px; font-weight: bold; color:yellow"><%=request.getParameter("status")%></span>
					  <%}%>
					  </div></td>
                      </tr>
                      <tr>
                  	...
                  	<p align="center" class="style4" style="font-size:30px; font-weight: bold"> INBOX </p><br/>
                      ...
                      <tr>
                        ...
                        <td width="153" bgcolor="skyblue"><div align="center" class="style15" style="font-size:20px; font-weight: bold"> From </div></td>
                        <td width="221" bgcolor="skyblue"><div align="center" class="style15" style="font-size:20px; font-weight: bold">Subject</div></td>
                        <td width="147" bgcolor="skyblue"><div align="center" class="style15" style="font-size:20px; font-weight: bold">Send Date</div></td>
                      </tr>
                      <%
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE" style="font-size:18px; font-weight: bold">
                          <span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=ViewInbox.jsp"><%=from%></a></span></td>
                        <td bgcolor="#FFD7AE" style="font-size:18px; font-weight: bold"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=ViewInbox.jsp">
						<%=subject%></a></span></td>
						 <td bgcolor="#FFD7AE" style="font-size:18px; font-weight: bold"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=ViewInbox.jsp"><%=senddate%></a></span></td>
                      </tr>
                      <%} %>
                      <tr>
                        <td colspan="4"  bgcolor="#FFFFFF"><label>
                          <div align="center">
                            <input type="submit" name="Submit" value="Delete" style="height:30px; width: 120px; font-size:20px;">
                            &nbsp;
                            <input type="reset" value="Clear" style="height:30px; width: 120px; font-size:20px;">
                            </div>
                        </label></td>
                        </tr>
