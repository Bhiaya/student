				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="472" border="0" align="center">
                  	...
                  	<p align="center" class="style4" style="font-size:30px; font-weight: bold"> Sent Items </p><br/>
                      ...
                      <tr>
                        ...
                        <td width="153" bgcolor="skyblue"><div align="center" class="style15" style="font-size:20px; font-weight: bold"> To </div></td>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE" style="font-size:18px; font-weight: bold"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=ViewOutbox.jsp">
						<%=subject%></a></span></td>
						 <td bgcolor="#FFD7AE" style="font-size:18px; font-weight: bold"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=ViewOutbox.jsp"><%=senddate%></a></span></td>
                      </tr>
                       <%} %>
                      <tr>
